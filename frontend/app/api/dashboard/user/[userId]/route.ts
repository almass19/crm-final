...
export async function GET(
  ...
  try {
    ...
    const clientSelect = 'id, full_name, company_name, phone, group_name, status, services, payment_amount, purchase_date, created_at, assigned_at, designer_assigned_at';
